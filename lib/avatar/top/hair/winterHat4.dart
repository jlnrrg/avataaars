...
String _winterHat4(Color color) {
  ...
  final _mask4 = UniqueKey().hashCode.toString();

  return """
<g id='Top'>
        <defs>
          <rect id="$_path5" x='0' y='0' width='264' height='280' />
          <path
        ...
        >
          ...
          <g id='hat-front'>
            <use
              ...
              xlink:href="${'#' + _path4}"
            />
            <use fill='#F4F4F4' fill-rule='evenodd' xlink:href="${'#' + _path4}" />
          </g>
        </g>
      </g>
""";
