...
String _shortHairTheCaesarSidePart(Color color) {
...
<g id='Top' stroke-width='1' fill-rule='evenodd'>
        ...
        <g id='Mask' />
        <g id='Top/Short-Hair/The-Caesar-+-Side-Part' mask="url(#$_mask1)">
          <g transform='translate(-1.000000, 0.000000)'>
            <g
              ...
              <use id='Caesar' fill='#28354B' xlink:href="${'#' + _path2}" />
              ${_makeHairColor(_mask2, color)}
            </g>
          </g>
        </g>
      </g>
