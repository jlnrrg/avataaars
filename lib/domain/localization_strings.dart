...
class LocalizationStrings with _$LocalizationStrings {
  ...
  String toEnglish() => when(
        ...
        longHairBigHair: () => 'Langes Haar, Big',
        longHairBob: () => 'Langes Haar, Bob',
        longHairBun: () => 'Langes Haar, Bun',
        longHairCurly: () => 'Langes Haar, Curly',
        longHairCurvy: () => 'Langes Haar, Curvy',
        ...
        longHairNotTooLong: () => 'Langes Haar, Not Too Long',
        longHairShavedSides: () => 'Langes Haar, Shaved Sides',
        longHairMiaWallace: () => 'Langes Haar, Mia Wallace',
        longHairStraight: () => 'Langes Haar, Straight',
        longHairStraight2: () => 'Langes Haar, Straight 2',
        longHairStraightStrand: () => 'Langes Haar, Straight Strand',
        shortHairDreads01: () => 'Kurzes Haar, Dreads 1',
        shortHairDreads02: () => 'Kurzes Haar, Dreads 2',
        shortHairFrizzle: () => 'Kurzes Haar, Frizzle',
        shortHairShaggyMullet: () => 'Kurzes Haar, Shaggy Mullet',
        shortHairShortCurly: () => 'Kurzes Haar, Curly',
        shortHairShortFlat: () => 'Kurzes Haar, Flat',
        shortHairShortRound: () => 'Kurzes Haar, Round',
        shortHairShortWaved: () => 'Kurzes Haar, Waved',
        shortHairSides: () => 'Kurzes Haar, Sides',
        shortHairTheCaesar: () => 'Kurzes Haar, Caesar',
        shortHairTheCaesarSidePart: () => 'Kurzes Haar, Caesar Side Part',
        eyesClosed: () => 'Closed',
        eyesCry: () => 'Cry',
        eyesDefault: () => 'Default',
        eyesDizzy: () => 'Dizzy',
